...
# ================================================================================================================
    ...
    def encrypt_block(self, mpw_list):
        ...
        for i, pw_seed in enumerate(self.pw_seed_list):
            mpw = mpw_list[i]
            aes = set_crypto(mpw)
            cipher_list.append(aes.encrypt(struct.pack('{}I'.format(len(pw_seed)), *pw_seed)))
        return cipher_list
...
# ================================================================================================================
    ...
    def save_single_pw(self, pw, index):
        ...
        for x in range(self.T):
            ...
            aes = set_crypto(mpw)
            pw_cipher = aes.encrypt(struct.pack('{}I'.format(MAX_PW_LENGTH), *seed))
